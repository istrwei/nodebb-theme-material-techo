...
<div class="col-lg-4 col-md-6 col-sm-12" data-slug="{groups.slug}">
    <div class="card">
        ...
        <a href="{config.relative_path}/groups/{groups.slug}" class="card-body group-cover list-cover" style="<!-- IF groups.cover:thumb:url -->background-image: url({groups.cover:thumb:url}); background-size: 100%; background-repeat: no-repeat; background-position: {groups.cover:position};<!-- ENDIF groups.cover:thumb:url -->">
        </a>
